...
namespace PhxGaugingAndroid
{
    ...
    public class BackGroudGaugingActivityExepc : Activity
    {
        ...
        TextView bgTextTime;
        TextView bgPPM;
        TextView bgTextPPMPID;
        TextView bgTextTimePID;
        TextView bgPPMPID;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.BackGroudGaugingExepc);
            ...
            bgTextPPMPID = FindViewById<TextView>(Resource.Id.bgTextPPMPID);
            bgTextTimePID = FindViewById<TextView>(Resource.Id.bgTextTimePID);
            bgPPMPID = FindViewById<TextView>(Resource.Id.bgPPMPID);
        ...
        private void Timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            if (this != null)
            {
                this.RunOnUiThread(delegate { bgTextTime.Text = second.ToString(); bgTextTimePID.Text = second.ToString(); });
            }
        }
        ...
        private void BtnStartBGGau_Click(object sender, EventArgs e)
        {
            ...
            if (IsGauging == false)
            {
                ...
                {
                    Toast.MakeText(this, "请先连接WIFI", ToastLength.Short).Show();
                    return;
                }
            ...
            if (IsGauging)
            {
                ...
                bgTextPPMPID.Text = string.Empty;
                bgPPM.Text = String.Empty;
                bgPPMPID.Text = String.Empty;
                second = 0;
                bgTextTime.Text = second.ToString();
                bgTextTimePID.Text = second.ToString();
        ...
        private void ExepcService_DataPoll(float FID, float PID)
        {
            ...
            if (this != null)
            {
                this.RunOnUiThread(delegate
                {
                    ...
                    bgPPM.Text = FID.ToString();
                    bgTextPPMPID.Text = ppmpid.ToString();
                    bgPPMPID.Text = PID.ToString();
                });
            }
        }
