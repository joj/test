...
{
    public class TvaSealPointFragment : Fragment
    {
        private AndroidGroup group;
        private List<AndroidGroup> groupList;
        private int position;
        public Bitmap btp;
        public TvaSealPointFragment(List<AndroidGroup> groupList, int position)
        {
        ...
        {
            var adapter = lvSealPoints.Adapter as TvaSealPointAdapter;
        ...
        public override bool OnContextItemSelected(IMenuItem item)
        {
            ...
            try
            {
                ...
                var pointAdap = adapter as TvaSealPointAdapter;
        ...
        private void SetSealPointListAdapter()
        {
            ...
            try
            {
                ...
                adapter = new TvaSealPointAdapter(this.Activity, sealPointList, group);
