...
{
    public class TvaSealPointAdapter : BaseAdapter<AndroidSealPoint>
    {
        ...
        public TvaSealPointAdapter(Activity contex, List<AndroidSealPoint> items, AndroidGroup group)
        {
            this.group = group;
            this.context = contex;
            this.items = items;
        ...
        public void Btn_Click(object sender, EventArgs e)
        {
            if (IsDataPolling == false)
            {
                ...
                {
                    Toast.MakeText(context, "请先连接蓝牙", ToastLength.Short).Show();
                    return;
                }
            ...
            else
            {
                ...
                try
                {
                    ...
                    point.PhxCode = App.tvaService.Name;
