...
{
    public class GaugingFragmentTva : Fragment, StopReceiveData
    {
        ...
        Activity context;
        public static GaugingFragmentTva NewInstance()
        {
            var frag3 = new GaugingFragmentTva { Arguments = new Bundle() };
            return frag3;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            if (IsSave == false)
            {
                ...
                if (App.tvaService.IsConnected == true)
                {
